        ...
        if &raw_data[i..i+4] == b"GPS5" {
            ...
            if data_start + data_len <= raw_data.len() && item_size >= 16 {
                ...
                for c in 0..item_count {
                    ...
                    let lat = i32::from_be_bytes([raw_data[off], raw_data[off+1], raw_data[off+2], raw_data[off+3]]) as f64 / 10000000.0;
                    let lon = i32::from_be_bytes([raw_data[off+4], raw_data[off+5], raw_data[off+6], raw_data[off+7]]) as f64 / 10000000.0;
